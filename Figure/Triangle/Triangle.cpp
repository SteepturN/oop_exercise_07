...
#include "Triangle.h"
// template <typename T>
// inline constexpr typename Figure<T>::size_type Triangle<T>::size() const noexcept {
// 	return NUM_OF_VERTECES;
// }

// template <typename T>
// inline void Triangle<T>::type() const noexcept {
// 	std::cout << "triangle";
// }
...
//«std::istream& operator>><int>(std::istream&, Triangle<int>&)»
template <typename T>
...
// template <typename T>
// void make_2_more_verteces(Triangle<T>& t, double side_length) {
